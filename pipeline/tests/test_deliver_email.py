"""Tests for arxiv_digest.deliver_email email building and sending."""

import smtplib
from unittest.mock import MagicMock, patch

from arxiv_digest.deliver_email import build_email, send_email  # noqa: E402
...
def test_send_email_success():
    ...
    mock_smtp = MagicMock()
    with patch("arxiv_digest.deliver_email.smtplib.SMTP") as smtp_cls:
