...
def fetch_arxiv_papers(categories: List[str], start_date: str, end_date: str, max_results: int = 1000) -> List[Dict]:
    """
...
def main():
    ...
    parser.add_argument(
        ...
        help="Output JSON file (default: daily_papers.json)"
    )
    parser.add_argument(
        "--max-results",
        type=int,
        default=1000,
        help="Max results per category (default: 1000)"
    )
